...
const Register = () => {
    ...
    return (
        <View >
            ...
            {/* TÊN FORM Ở ĐÂY  */}
            <Text style={{ color: "#8bc6f0", fontWeight: "bold", fontSize: 50, textAlign: "center", margin: 30 }}>Register</Text>
            {/* NHẬP ĐIỆN THOẠI  */}
            ...
            <TextInput placeholder='Nhập lại mật khẩu  ' style={{ width: "70%", height: 50, backgroundColor: "#8bc6f0", marginLeft: "15%", marginRight: "15%", marginTop: 15 }} />
            {/* NÚT ĐĂNG KÝ Ở ĐÂY  */}
