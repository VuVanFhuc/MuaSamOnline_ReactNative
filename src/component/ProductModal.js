...
// import { View, Text, Image, StyleSheet, Modal, Pressable, Alert, TextInput } from 'react-native';
...
//                     <Text style={styles.productPrice}>{`Giá: ${selectedItem.price}`}</Text>
//                     <Text style={styles.paymentMethodLabel}>Số lượng:</Text>
...
//                         </Pressable>
//                     </View>
//                     <Text style={styles.totalPrice}>{`Thành tiền: ${totalPrice}`}</Text>
